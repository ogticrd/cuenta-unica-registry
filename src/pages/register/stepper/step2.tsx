            ...
            <GridContainer marginY>
                <GridItem md={12} lg={12}>
                    <div style={{ background: "#EFF7FF", borderRadius: "6px", padding: "30px 20px", display: "flex", alignItems: "center", flexDirection: "row" }}>
                        <CameraAltOutlinedIcon sx={{ fontSize: "45px", marginRight: "12px" }} color="info" />
                        <Typography variant="body2" color="primary">Tener disponible un teléfono móvil o computadora con <span style={{ fontWeight: "bold" }}>cámara</span> integrada.</Typography>
                    </div>
                </GridItem>
                ...
                <GridItem md={12} lg={12}>
                    <div style={{ background: "#EFF7FF", borderRadius: "6px", padding: "30px 20px", display: "flex", alignItems: "center", flexDirection: "row" }}>
                        <SentimentSatisfiedOutlinedIcon sx={{ fontSize: "45px", marginRight: "12px" }} color="info" />
                        <Typography variant="body2" color="primary">Permitir capturas de <span style={{ fontWeight: "bold" }}>fotografías de tu rostro.</span></Typography>
                    </div>
                </GridItem>
