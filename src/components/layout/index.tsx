  ...
  return (
    <>
      ...
      <div style={{ padding: '50px 0px' }}>
        {children}
          <Fab onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSexFmkoGsVbyRS90B1IwRoAjYg6R6mX8IAJiT1BExN9wT7yjA/viewform?usp=pp_url")} size={matches ? 'large' : 'small'} variant={matches ? 'extended' : 'circular'} sx={{ position: 'fixed', top: matches ? '40vh' : '80vh', right: matches ? '40px' : '5px', background: 'white', textTransform: 'none', fontWeight: 'bold', color: theme.palette.primary.main }}>
