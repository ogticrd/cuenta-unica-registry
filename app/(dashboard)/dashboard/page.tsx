...
export default function DashboardPage() {
  ...
  if (isAal2) {
    ...
    securityColorClass =
      "bg-green-50 border-green-200 hover:bg-green-100 text-green-700 dark:bg-green-900/20 dark:border-green-800/50 dark:hover:bg-green-900/40 dark:text-green-400";
  } else {
    securityLevelText = t("stats_cards.security.level_standard");
    securityColorClass =
      "bg-amber-50 border-amber-200 hover:bg-amber-100 text-amber-700 dark:bg-amber-900/20 dark:border-amber-800/50 dark:hover:bg-amber-900/40 dark:text-amber-400";
  }
