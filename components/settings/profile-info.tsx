    ...
    return (
        <div className="max-w-6xl space-y-8 mb-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-bold text-primary mb-2">Mis datos personales</h1>
                    <p className="text-gray-600">Información oficial registrada en el sistema gubernamental</p>
                </div>
            ...
            <Card className="border-l-4 border-l-amber-400 bg-amber-50/50">
                <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-amber-800 mb-1">Información oficial</h3>
                        ...
                        <CardContent className="space-y-6">
                            <div className="relative inline-block">
                                <Avatar className="relative overflow-visible" style={{ width: "128px", height: "128px" }}>
                                    <AvatarFallback className="text-5xl">{user?.name?.trim()?.[0]?.toUpperCase()}</AvatarFallback>
                                </Avatar>
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-600 font-medium">Cédula: {user.cedula}</p>
                ...
                <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 mb-2">Fuente de datos oficial</h3>
            ...
            <Card className="border-gray-200">
                <CardContent className="p-6">
                    <div className="text-center space-y-3">
                        <h3 className="font-semibold text-gray-900">¿Necesitas actualizar tu información?</h3>
