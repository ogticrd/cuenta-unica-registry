  ...
  ({
    ...
    useEffect(() => {
      ...
      function tick() {
        ...
        const grad = canvasContext.createLinearGradient(0, 0, w, h);
        ...
        for (let i = 0; i < len; i++) {
          ...
          if (p.sparkle) {
            ...
            if (hash % 100 < 3) {
              canvasContext.moveTo(drawX + rad * 1.8, drawY);
              canvasContext.arc(drawX, drawY, rad * 1.8, 0, TWO_PI);
            } else {
              canvasContext.moveTo(drawX + rad, drawY);
              canvasContext.arc(drawX, drawY, rad, 0, TWO_PI);
            }
          } else {
            canvasContext.moveTo(drawX + rad, drawY);
            canvasContext.arc(drawX, drawY, rad, 0, TWO_PI);
        ...
        >
          <defs>
            <radialGradient id={glowIdRef.current}>
              ...
              <stop offset="25%" stopColor={glowColor} stopOpacity="0" />
            </radialGradient>
          </defs>
          <circle
            ref={glowRef}
