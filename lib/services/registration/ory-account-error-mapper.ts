...
const PASSWORD_MESSAGE_IDS = new Set<number>([4000005, 4000031, 4000032, 4000033, 4000034])
...
function collectFieldMessages(payload: OryAccountErrorPayload): OryFieldMessage[] {
