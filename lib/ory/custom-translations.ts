...
export const oryCustomTranslations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "identities.messages.4000027":
      "Ya existe una cuenta con este correo electrónico. Inicia sesión para continuar.",
    "identities.messages.4000031":
      "La contraseña no puede contener tu correo electrónico.",
    "identities.messages.4000032":
      "La contraseña debe tener al menos 10 caracteres.",
    "identities.messages.4000033":
      "La contraseña excede la longitud máxima permitida.",
  ...
  en: {
    ...
    "identities.messages.4000031":
      "The password cannot contain your email address.",
    "identities.messages.4000032":
