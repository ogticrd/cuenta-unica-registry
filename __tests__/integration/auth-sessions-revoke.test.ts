...
describe("DELETE /api/ory/sessions/[id]", () => {
    it("revokes a session by id and returns success", async () => {
        ...
        const request = new Request("http://localhost/api/ory/sessions/session-123", {
            method: "DELETE",
        });
    ...
    it("returns 500 when Ory fails to disable the session", async () => {
        ...
        const request = new Request("http://localhost/api/ory/sessions/session-456", {
            method: "DELETE",
        });
    ...
    it("forwards the full browser cookie string to Ory", async () => {
        ...
        const request = new Request("http://localhost/api/ory/sessions/session-789", {
            method: "DELETE",
        });
    ...
    it("handles empty cookie header gracefully", async () => {
        ...
        const request = new Request("http://localhost/api/ory/sessions/session-000", {
            method: "DELETE",
        });
